...
theme_options: List[BaseOption] = [
	...
	CopyOption(_id="btop", name="btop.theme", path_to=HOME / ".config" / "btop" / "themes" / "billarch.theme"),
	CopyOption(_id="micro", name="theme.micro", path_to=HOME / ".config" / "micro" / "colorschemes" / "billarch.micro"),
	...
	CopyOrGenOption(
		_id="alacritty",
		name="alacritty.toml",
		path_to=HOME / ".config" / "alacritty" / "themes" / "billarch.toml",
		template_name="alacritty.mustache"
	),
	CopyOrGenOption(
		_id="qt5ct",
		name="qt5ct-colors.conf",
		path_to=HOME / ".config" / "qt5ct" / "colors" / "billarch.conf",
		template_name="qt5ct-colors.mustache"
	),
	CopyOrGenOption(
		_id="qt6ct",
		name="qt6ct-colors.conf",
		path_to=HOME / ".config" / "qt6ct" / "colors" / "billarch.conf",
	...
	FishOption(
		...
		path_to=HOME / ".config" / "fish" / "themes" / "billarch.theme",
		apply_theme=True
	),
	KittyOption(
		_id="kitty",
		name="kitty.conf",
		path_to=HOME / ".config" / "kitty" / "themes" / "billarch.conf",
